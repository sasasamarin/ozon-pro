...
Delta migration on top of 2514856685d9 (initial_schema, autogenerated by an
earlier run on the VPS — file was recovered into the repo alongside this one).
